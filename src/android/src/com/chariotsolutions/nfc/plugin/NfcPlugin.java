...
        Log.v(TAG, command);
        // FIX: Replaced webView.sendJavascript with webView.loadUrl for compatibility with
        // modern Cordova-Android versions (where sendJavascript is removed/deprecated).
...
        Log.v(TAG, command);
        // FIX: Replaced webView.sendJavascript with webView.loadUrl for modern Cordova compatibility.
        this.webView.loadUrl("javascript:" + command);
    }
